    ...
    <form action="login" method="POST" >
      <div class="card border-0 px-3" style="width: 20em;">
        <div class="form-group">
            ...
            <input type="text" placeholder="Введите логин" class="form-control" name="login" value="${name}">
        </div>
        <div class="form-group">
            <label for="password" class="form-label mt-2">Пароль</label>
            <input type="password" placeholder="Введите пароль" class="form-control" name="password" value="${name}">
        </div>
